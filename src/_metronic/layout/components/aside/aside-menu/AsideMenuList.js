  ...
  return (
    <Hoc>
      ...
      <ul className={`menu-nav ${layoutProps.ulClasses}`}>
        ...
        {/*begin::1 With text feild*/}
        <li
          className={`menu-item ${getMenuItemActive("/withTextField", false)}`}
          aria-haspopup="true"
        >
          <NavLink className="menu-link" to="/withTextField">
            ...
            <span className="menu-text">withTextField</span>
          </NavLink>
        </li>
        {/*begin::1 With text feild*/}
        <li
          className={`menu-item ${getMenuItemActive("/withCheckboxAndRadio", false)}`}
          aria-haspopup="true"
        >
          <NavLink className="menu-link" to="/withCheckboxAndRadio">
            ...
            <span className="menu-text">With CheckboxAndRadio</span>
          </NavLink>
        </li>
        {/*begin::1 With text feild*/}
        <li
        ...
        >
          <NavLink className="menu-link" to="/withDropdown">
            ...
            <span className="menu-text">With Dropdown</span>
          </NavLink>
        </li>
        {/*begin::1 With text feild*/}
        <li
          className={`menu-item ${getMenuItemActive("/withDatepicker", false)}`}
          aria-haspopup="true"
        >
          <NavLink className="menu-link" to="/withDatepicker">
            ...
            <span className="menu-text">With Datepicker</span>
          </NavLink>
        </li>
      </ul>
      {/* end::Menu Nav */}
